...
namespace OnlineStoreFrontNet7.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult SummaryPOST()
        {
            ...
            {
                // if it equals zero it is a null companyId...regular customer and capture payment
            ...
            _unitOfWork.Save();
            //creates order header id in database to be used below
            ...
            if (applicationUser.CompanyId.GetValueOrDefault() == 0)
            {
                // regular customer and capture payment
                //strip logic
                ...
                //after above line app is redirected to stripe to proccess payment(this generates the PaymentIntentId)**It is null above**
